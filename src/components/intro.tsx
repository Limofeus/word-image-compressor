      ...
      <div className="container mx-auto py-8 2xl:max-w-[1400px]">
        ...
        <div className="mx-auto mt-4 max-w-3xl text-center">
          <p className="text-muted-foreground text-lg !leading-6">
            Загрузите свой DOCX, вытащите картинки из word/media/, сожмите их до
            состояния шакала и соберите обратно. Без облаков, без API, без шансов
            на проверку плагиата по весу файла.
          </p>
        </div>
      </div>
    </section>
